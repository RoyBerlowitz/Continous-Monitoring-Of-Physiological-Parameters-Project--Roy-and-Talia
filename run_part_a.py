...
if __name__ == "__main__":
    ...
    split1_dfs, split2_dfs = run_part_a(data_path, save_cache=False,more_prints=True, force_recompute_load_data=False, force_recompute_seg=True, force_recompute_features=False, force_recompute_splits=False, force_recompute_vet_features = False)
