...
# תיקייה שבה נמצאים קבצי ה-Excel
input_folder = r"C:\Users\nirei\Downloads\02-20251130T201709Z-1-001\02"

# תיקייה שאליה יישמרו קבצי ה-CSV
...
for file in os.listdir(input_folder):
    if file.endswith(".xlsx") or file.endswith(".xls"):
        ...
        csv_path = os.path.join(output_folder, file.rsplit(".", 1)[0] + ".csv")
...
if __name__ == "__main__":
    ...
    X_features, Y_vector = run_part_a(data_path, force_recompute_seg=True, force_recompute_features=False, force_recompute_splits=False)
