...
def find_best_random_forrest_parameters (train_df, train_labels, group_indicator, n_jobs = -1, n_iterations = 100, split_by_group_flag = False, subsampling_flg = False):
