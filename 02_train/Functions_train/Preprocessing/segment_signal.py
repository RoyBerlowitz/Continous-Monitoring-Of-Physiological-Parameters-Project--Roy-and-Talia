...
def segment_signal(window_size, window_step, data_files, more_prints=False):
...
def segment_signal_test(window_size, window_step, data_files, more_prints=False):
    if more_prints: print('============================ Segmenting signal again :)))')
